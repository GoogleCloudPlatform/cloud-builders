...
This repository contains source code for official builders used with the
[Google Cloud Build API](https://cloud.google.com/cloud-build/docs/).
...
*   `dotnet`: run the [dotnet](https://docs.microsoft.com/dotnet/core/tools/)
    tool
